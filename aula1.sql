...
--SELECT aula01.students.first_name, aula01.students.last_name, aula01.students.gender FROM aula01.students;

Select students.first_name as primeiro_nome, students.last_name as ultimo nome 
